...
const ProjectConfig: React.FC<Props> = ({
  ...
  const { collapseProps: projectCollapseProps, shouldRender: projectShouldRender } = useCollapse({ isCollapsed: isProjectCollapsed });
  const { collapseProps: environmentsCollapseProps, shouldRender: environmentsShouldRender } = useCollapse({ isCollapsed: isEnvironmentsCollapsed });
